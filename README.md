Week-06 <img src="https://raw.githubusercontent.com/slu-soc5050/Core-Documents/sources/soc5050LogoSm_v2.png" align="right" />
===========================================================
![](https://img.shields.io/badge/semester-Fall%2C%202017-blue.svg) ![](https://img.shields.io/badge/release-updated-brightgreen.svg)
![](https://img.shields.io/github/last-commit/slu-soc5050/Week-06.svg) ![](https://img.shields.io/github/repo-size/slu-soc5050/Week-06.svg)

### Repository Contents
This repository contains files for:
  - `Equations/` - equation quick reference sheet
  - `Functions/` - function quick reference sheet
  - `Lab/` - lab instructions for lab-06
  - `PS-05/` - problem set 05
  - `Slides/` - slides for all lectures
  - `WeeklyPrep/` - weekly prep for week 06
  - `.gitignore`
  - `LICENSE`
  - `LICENSE_TEXT.md`
  - `README.md`
